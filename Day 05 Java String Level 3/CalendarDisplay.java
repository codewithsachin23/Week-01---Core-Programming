...
public class CalendarDisplay {
	public static int getInpotFromUser(Scanner input,String message){
    ...
    public static void main(String[] args) {
		...
		int month=getInpotFromUser(input,"Enter month (1-12): ");
		int year=getInpotFromUser(input,"Enter year: ");
